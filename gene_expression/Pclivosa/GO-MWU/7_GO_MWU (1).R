...
MWU_result_BP_TreatedvInitial=read.csv("MWU_BP_Treated_vs_Initial_fc.csv", sep = "")#0 sig terms at 0.05
MWU_result_CC_TreatedvInitial=read.csv("MWU_CC_Treated_vs_Initial_fc.csv", sep = "")#3 sig terms at 0.05

MWU_result_BP_TreatedvUntreated=read.csv("MWU_BP_Treated_vs_Untreated_fc.csv", sep = "") #0 sig terms at 0.05
MWU_result_MF_TreatedvUntreated=read.csv("MWU_MF_Treated_vs_Untreated_fc.csv", sep = "") #0 sig terms at 0.05
MWU_result_CC_TreatedvUntreated=read.csv("MWU_CC_Treated_vs_Untreated_fc.csv", sep = "") #0 sig terms at 0.05

MWU_result_BP_UntreatedvInitial=read.csv("MWU_BP_Untreated_vs_Initial_fc.csv", sep = "")#0 sig terms at 0.05
MWU_result_MF_UtreatedvInitial=read.csv("MWU_MF_Untreated_vs_Initial_fc.csv", sep = "")#0 sig terms at 0.05
MWU_result_CC_UtreatedvInitial=read.csv("MWU_CC_Untreated_vs_Initial_fc.csv", sep = "")#0 sig terms at 0.05
...
# text representation of results, with actual adjusted p-values
results
write.csv(results, file = "Treated_v_Initial_MF_p0.05.csv")
