...
ncol(countData) #48
#write.csv(countData, file="OneDrive - University of Miami/GitHub/Ch2_temperaturevariability2023/gene_expression/countData.csv")
...
#write.csv(counts4wgcna, file="OneDrive - University of Miami/GitHub/Ch2_temperaturevariability2023/gene_expression/counts4wgcna.csv")
