...
save all files so you don't have to keep rerunning enrichment
```{r}
...
KEGG_enrich_TvU_categories %>% 
  filter(p.adjust<0.05) 
  # write_csv("TvU_sigKEGGpathways.csv")
  #4 categories and they all have different descriptions

# map05200	Pathways in cancer 	Human Diseases; Cancer: overview
...
what are the genes specifically involved in each significant KEGG pathway?
```{r}
Treated_vs_Untreated.fc %>% right_join(kegg.list, by = "gene") %>% 
