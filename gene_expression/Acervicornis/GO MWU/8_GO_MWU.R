...
# Treated_vs_Untreated_lpv <- read_csv("Treated_vs_Untreated_lpv.csv")
...
# Untreated_vs_Initial_lpv <- read_csv("Untreated_vs_Initial_lpv.csv")
...
# Edit these to match your data file names: 
input="control0_control29_fc.csv" # two columns of comma-separated values: gene id, continuous measure of significance. 
#input="variable0_variable29_fc.csv" 
#input="variable0_control0_fc.csv" 
#input="variable29_control29_fc.csv"
...
# text representation of results, with actual adjusted p-values
results
write.csv(results, file = "X.csv")


#### wgcna modules ####

# Edit these to match your data file names: 
input="royalblue.csv" # two columns of comma-separated values: gene id, continuous measure of significance. 
