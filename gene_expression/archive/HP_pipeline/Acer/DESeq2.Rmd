...
## Creating a combination the factors of interest into a single factor with all combinations of the original factors
```{r}
...
```{r}
summary(results(dds_combo, contrast = c("group", "variable_Day_0", "control_Day_0")))
```



```{r}
summary(results(dds_combo, contrast = c("group", "variable_Day_29", "control_Day_29"), alpha = 0.05))
```
