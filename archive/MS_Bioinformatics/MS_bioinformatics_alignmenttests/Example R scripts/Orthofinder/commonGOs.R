...
trans_mcav_diseased_healthy_MF <- read.csv(file = "../transmission/GO-MWU/mcav2015/diseased_healthy_lpv_MF_p0.05.csv") %>%
  select(X, pval, term, direction) %>%
  rename("name" = X, "pval_mcav_dh_MF" = pval)
