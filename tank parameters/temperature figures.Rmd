...
ggsave("summarytemptreatment.pdf")
```
...
#this is messy because each tank was "stopped" at different times, depending on when all the corals died or not. there was also a dip in temps for all of them where they went back down to 28 because of human error in setting the program
