...
heatstressassay %>% 
  arrange(desc(Time)) #high temp in tank 4 goes until the very end, july 22. when do i call the "End of experiment"?
...
heatstressassay %>% 
 dplyr::select(Time, T3, T4, T7, T8) %>% 
  ...
  filter(Tank == "T3") %>% 
  filter(Temp > 31) %>% 
  arrange(desc(Time)) #T3 went all the way to july 22
...
heatstressassay %>% 
 dplyr::select(Time, T3, T4, T7, T8) %>% 
  ...
  filter(Tank == "T4") %>% 
  filter(Temp > 31) %>% 
  arrange(desc(Time)) #T4 went to july 22
...
heatstressassay %>% 
 dplyr::select(Time, T3, T4, T7, T8) %>% 
  ...
  filter(Tank == "T8") %>% 
  filter(Temp > 31) %>% 
  arrange(desc(Time)) #T8 stopped heat stress on july 13
