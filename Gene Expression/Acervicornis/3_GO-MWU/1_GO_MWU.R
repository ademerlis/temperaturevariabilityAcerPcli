...
#### L2FC (log 2-fold change) files ####

# Edit these to match your data file names: 

input="Variable_vs_Initial_fc.csv" 
# BP 802 
# MF 117
# CC 156

input="Control_vs_Initial_fc.csv" 
# BP 651
# MF 105
# CC 149

input="Variable_vs_Control_fc.csv" 
#BP 160
# MF 15
# CC 89
...
MWU_result_BP_VariablevInitial=read.csv("MWU_BP_Variable_vs_Initial_fc.csv", sep = "")
...
allgenes_BP_VariablevInitial=read.csv("BP_Variable_vs_Initial_fc.csv", sep="")
MWU_result_BP_VariablevInitial %>% 
  filter(p.adj < 0.05) %>%  #543 rows
  left_join(., allgenes_BP_VariablevInitial, by = c("name", "term")) %>% view()

MWU_result_MF_VariablevInitial=read.csv("MWU_MF_Variable_vs_Initial_fc.csv", sep = "")
...
MWU_result_CC_VariablevInitial=read.csv("MWU_CC_Variable_vs_Initial_fc.csv", sep = "")
...
MWU_result_BP_VariablevControl=read.csv("MWU_BP_Variable_vs_Control_fc.csv", sep = "")
...
MWU_result_MF_VariablevControl=read.csv("MWU_MF_Variable_vs_Control_fc.csv", sep = "")
...
MWU_result_CC_VariablevControl=read.csv("MWU_CC_Variable_vs_Control_fc.csv", sep = "")
...
MWU_result_BP_ControlvInitial=read.csv("MWU_BP_Control_vs_Initial_fc.csv", sep = "")
...
MWU_result_MF_UtreatedvInitial=read.csv("MWU_MF_Control_vs_Initial_fc.csv", sep = "")
...
MWU_result_CC_UtreatedvInitial=read.csv("MWU_CC_Control_vs_Initial_fc.csv", sep = "")
...
results
write.csv(results, file = "VariablevsControl_CC_fc_05.csv")

#### lpv (log-padj value) files ####

# Edit these to match your data file names: 

# two columns of comma-separated values: gene id, continuous measure of significance. 

input="Variable_vs_Initial_lpv.csv" 
# MF 151 GO terms at 10% FDR 
# BP 869
# CC 185

input="Control_vs_Initial_lpv.csv" 
# MF 129
# BP 684
# CC 176

input="Variable_vs_Control_lpv.csv" 
# MF 24
# BP 218 
# CC 100
...
# text representation of results, with actual adjusted p-values
results
write.csv(results, file = "VariablevsControl_lpv_CC_05.csv")

#### (ARCHIVE) Fisher exact test ####
...
treated_vs_initial=read.csv("Variable_vs_Initial_lpv.csv")
...
treated_vs_initial %>% 
  write_csv("Variable_vs_Initial_lpv_fisher.csv")

input="Variable_vs_Initial_lpv_fisher.csv" 
