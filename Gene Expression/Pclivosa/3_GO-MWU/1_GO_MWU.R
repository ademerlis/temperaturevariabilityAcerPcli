...
goAnnotations="Pclivosa_iso2go.tab" # two-column, tab-delimited, one line per gene, 
...
#### (L2FC) fold change files ####

# Edit these to match your data file names:

input="Variable_vs_Initial_fc.csv" # two columns of comma-separated values: gene id, continuous measure of significance. 
#0 MF
#8 CC
#0 GO terms for BP
...
#0 GO terms for BP
#1 GO term for MF - but it is not < 0.05
#0 CC
...
MWU_result_BP_VariablevInitial=read.csv("MWU_BP_Variable_vs_Initial_fc.csv", sep = "")#0 sig terms at 0.05
MWU_result_CC_VariablevInitial=read.csv("MWU_CC_Variable_vs_Initial_fc.csv", sep = "")#3 sig terms at 0.05

MWU_result_BP_VariablevControl=read.csv("MWU_BP_Variable_vs_Control_fc.csv", sep = "") #0 sig terms at 0.05
MWU_result_MF_VariablevControl=read.csv("MWU_MF_Variable_vs_Control_fc.csv", sep = "") #0 sig terms at 0.05
MWU_result_CC_VariablevControl=read.csv("MWU_CC_Variable_vs_Control_fc.csv", sep = "") #0 sig terms at 0.05

MWU_result_BP_ControlvInitial=read.csv("MWU_BP_Control_vs_Initial_fc.csv", sep = "")#0 sig terms at 0.05
MWU_result_MF_UtreatedvInitial=read.csv("MWU_MF_Control_vs_Initial_fc.csv", sep = "")#0 sig terms at 0.05
MWU_result_CC_UtreatedvInitial=read.csv("MWU_CC_Control_vs_Initial_fc.csv", sep = "")#0 sig terms at 0.05
...
results
write.csv(results, file = "Variable_vs_Initial_CC_fc.csv")
...
# text representation of results, with actual adjusted p-values
results
write.csv(results, file = "Variable_v_Initial_MF_p0.05.csv")
